  ...
  return (
    <div class="flex items-center justify-center p-4 bg-blue-100">
      <div class="max-w-xl text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
        ...
        <div className="my-7">
          <dl>
            <div class="bg-gray-50">
              <dt class="text-sm text-gray-500 font-medium leading-6">
                SHIPPING ADDRESS
              </dt>
              <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 w-full">
                <p className="my-2">
                  Smiles Davies <br></br>
                  600 Montgomery St <br></br>
        ...
        <div class="mt-8">
          <div class="flow-root">
            <span className="text-left text-lg text-gray-500">
              Items Ordered
            </span>
            <hr></hr>
          ...
          <table class="w-full text-sm text-left">
            <tbody>
              <tr class="bg-white">
                ...
                <td class="py-4  text-right">20% Off</td>
              </tr>
              <tr class="bg-white">
                <th scope="row" class="py-4 px-6 font-medium whitespace-nowrap">
                  Subtotal
                </th>
                <td class="py-4  text-right">3000</td>
              </tr>
              <tr class="bg-white">
                <th scope="row" class="py-4 px-6 font-medium whitespace-nowrap">
                  Total
                </th>
                <td class="py-4 text-right">4000</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="footer mt-7">
          <p className="text-center mb-8">Let's hang out ?</p>
          <div class="flex mt-6 space-x-6 sm:justify-center sm:mt-0">
